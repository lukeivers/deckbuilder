...
class Cards
  def self.cards
    return [
        ...
        Card.new(name: 'Arcane Intellect', effect: 'Draw 2 cards', cost: 3, type: :spell),
        ...
        Card.new(name: 'Water Elemental', effect: 'Freeze any character damaged by this minion', attack: 3,
                 health: 6, cost: 4, type: :minion),
        Card.new(name: 'Gnomish Inventor', battlecry: 'Draw a card', attack: 2, health: 4, cost: 4, type: :minion),
        Card.new(name: 'Fireball', effect: 'Deal 6 damage', cost: 4, type: :spell),
        Card.new(name: 'Polymorph', effect: 'Transform a minion into a 1/1 Sheep', cost: 4, type: :spell),
        ...
        Card.new(name: 'Stormwind Champion', effect: 'Your other minions have +1/+1', attack: 6, health: 6, cost: 7,
                 type: :minion),
        Card.new(name: 'Flamestrike', effect: 'Deal 4 damage to all enemy minions', cost: 7, type: :spell),
